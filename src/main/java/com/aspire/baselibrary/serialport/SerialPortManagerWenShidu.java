...
import com.aspire.baselibrary.serialport.message.SendMessage;
 ...
 */
public class SerialPortManagerWenShidu {

    private static final String TAG = "SerialPortManager";

    private SerialReadThreadWenshidu mReadThread;
    ...
    private static class InstanceHolder {
        ...
        public static SerialPortManagerWenShidu sManager = new SerialPortManagerWenShidu();
    }

    public static SerialPortManagerWenShidu instance() {
        return InstanceHolder.sManager;
    }

    private SerialPort mSerialPort;

    private SerialPortManagerWenShidu() {
    }
    ...
    public void setSchulder(Scheduler mSendScheduler1){
        mSendScheduler = mSendScheduler1;
    }
    /**
     * 打开串口
     *
    ...
    public SerialPort open(String devicePath, String baudrateString) {
        ...
        try {
            ...
            mReadThread = new SerialReadThreadWenshidu(mSerialPort.getInputStream());
            mReadThread.start();
