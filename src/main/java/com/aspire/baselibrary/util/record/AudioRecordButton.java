...
public class AudioRecordButton extends SuperTextView
        implements AudioManager.AudioStageListener {

    int colorNoChoose = Color.parseColor("#484848");
    int colorChoose = Color.parseColor("#59a1ff");
    //三个对话框的状态常量
    ...
    public AudioRecordButton(Context context, AttributeSet attrs) {
        ...
        setOnLongClickListener(v -> {
            //判断权限
            RxPermissions permissions=new RxPermissions(BaseActivityStackManager.INSTANCE.getNowActivity());
            boolean a=permissions.isGranted( Manifest.permission.WRITE_EXTERNAL_STORAGE);
            boolean b=permissions.isGranted( Manifest.permission.READ_EXTERNAL_STORAGE);
            boolean c=permissions.isGranted( Manifest.permission.RECORD_AUDIO);
            if(a && b && c){
                ...
                new RxPermissions(BaseActivityStackManager.INSTANCE.getNowActivity())
                        .request(
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                BaseToastUtil.INSTANCE.showToastShort("长按录音", -1);
            }
        });
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                setDrawableTint(colorChoose);
                setStrokeColor(colorChoose);
                break;
            ...
            case MotionEvent.ACTION_UP:
                ...
                setDrawableTint(colorNoChoose);
                setStrokeColor(colorNoChoose);
...
//                    setDrawableTint(Color.TRANSPARENT);
