 ...
 * Describe:
 */
public class BaseAutoWrapLinearlayoutRightToLeft extends LinearLayout {

    public BaseAutoWrapLinearlayoutRightToLeft(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseAutoWrapLinearlayoutRightToLeft(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }


    public BaseAutoWrapLinearlayoutRightToLeft(Context context) {
        super(context);
    }
...
//如果有子view，行数肯定至少1行
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0 ; i < getChildCount() ; i ++){
            ...
            Log.e("111说说","子view布局,左:"+left+",右:"+(left - child.getMeasuredWidth()));
            child.layout(left - child.getMeasuredWidth(), top, left, top + child.getMeasuredHeight());
