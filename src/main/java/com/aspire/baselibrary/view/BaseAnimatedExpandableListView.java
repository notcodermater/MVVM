 ...
 */
public class BaseAnimatedExpandableListView extends ExpandableListView {
    /*
    ...
    public BaseAnimatedExpandableListView(Context context) {
        super(context);
    }

    public BaseAnimatedExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseAnimatedExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private BaseAnimatedExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(BaseAnimatedExpandableListView parent) {
            this.parent = parent;
        }
